...
<div className="u-text-center pt-10" id="about">
  ...
  <div className="row u-center">
        ...
        <div className="content">
            <div className="tile">
                <div className="tile__container">
                    ...
                    <p className="tile__subtitle">Zimmerle & Wisloff</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div className="col-3 offset-1 w-28 ml-4 font-light text-xs tracking-tight">
    ...
    <div className="col-3 offset-1 w-32 ml-4">
      <div className="card card--slide-up">
    <div className="card__container">
    ...
    <div className="card__mobile-title">
        <div className="content">
            <div className="tile">
                <div className="tile__container">
                    <p className="tile__title">Chef Erik Wisloff</p>
                    <p className="tile__subtitle">Zimmerle & Wisloff</p>
                </div>
            </div>
        </div>
